    ...
    for (const file of req.files) {
        ...
        try {
            ...
            fs.unlink(imagePath, (err) => {
                if (err) {
                    console.log("failed to delete image from server, which image data failed to upload on mongoDB")
                }
                console.log("image deleted from server due to image data failed to upload on mongo db")
